		...
		try {
			...
			while (true) {
				...
				case "LOGIN":
					...
					System.out.println(
							"LOGIN - Resultado: " + (u != null ? "Usuario encontrado" : "Usuario no encontrado"));
				...
				case "CONSEGUIR_PROFESORES":
					...
					oos.flush();
					break;
				case "CONSEGUIR_REUNIONES":
					Integer userIdReuniones = (Integer) ois.readObject();
					String respuestaReuniones = metodos.obtenerReuniones(userIdReuniones);
